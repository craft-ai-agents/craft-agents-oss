...
export const mockWorkspaces: Workspace[] = [
  { id: 'ws-personal', name: 'Personal Notes', mcpUrl: 'https://mcp.craft.do/personal' },
  { id: 'ws-work', name: 'Work Projects', mcpUrl: 'https://mcp.craft.do/work' },
  { id: 'ws-research', name: 'Research', mcpUrl: 'https://mcp.craft.do/research' },
]
