...
description: "How to create Google OAuth credentials for Gmail, Calendar, Drive, Docs, and Sheets"
---

# Google OAuth Setup

Craft Agents does not include pre-configured Google OAuth credentials. You'll need to create your own Google Cloud project and OAuth credentials to use Google services (Gmail, Calendar, Drive, Docs, Sheets).
...
- The Client Secret is required by Google for Desktop apps (even with PKCE)
