...
<CardGroup cols={3}>
  ...
  <Card title="Lark / Feishu" icon="message" href="/messaging/lark">
    App ID + App Secret pairing via Lark Open Platform (international) or Feishu Open Platform (China). Long-connection mode, rich-text replies via Lark `post`, interactive cards, image/file attachments.
  </Card>
</CardGroup>
