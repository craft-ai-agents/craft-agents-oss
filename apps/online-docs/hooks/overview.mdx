...
<Info>
**Renamed:** `TodoStateChange` was renamed to `SessionStatusChange`. The old name still works as a deprecated alias but will show a validation warning. Update your hooks to use `SessionStatusChange`.
</Info>
