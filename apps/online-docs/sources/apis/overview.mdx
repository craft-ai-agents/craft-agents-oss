...
Full OAuth 2.0 flow with PKCE. Tokens are automatically refreshed and sent as `Authorization: Bearer {token}`. Works with any OAuth 2.0 provider — GitHub, Linear, Notion, Spotify, etc.
