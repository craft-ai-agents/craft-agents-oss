#!/usr/bin/env bun
/**
 * craft-cli — Terminal client for MDP server.
 *
 * Connects over WebSocket (ws:// or wss://) to a running MDP server
...
function printHelp(): void {
  process.stdout.write(`craft-cli — Terminal client for MDP server
