...
const EXPECTED_CHANNELS: string[] = [
  ...
  'input:setSpellCheck',
  'labelSkillBindings:changed',
  'labelSkillBindings:generateCompactInstruction',
  'labelSkillBindings:get',
  'labelSkillBindings:listBindableSkills',
  'labelSkillBindings:save',
  'labels:changed',
  'labels:create',
  'labels:delete',
  'labels:list',
