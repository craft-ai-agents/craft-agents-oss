...
const EXPECTED_CHANNELS: string[] = [
  ...
  'labels:delete',
  'labels:list',
  'llmInference:history',
  'llmInference:historyAll',
  ...
  'onboarding:getConnectedProvider',
  'onboarding:hasClaudeOAuthState',
  'onboarding:setConnectedProvider',
  ...
  'prompt:compile',
  'prompt:contextFilesChanged',
  'prompt:invalidate',
  'prompt:resolveContext',
  'releaseNotes:get',
