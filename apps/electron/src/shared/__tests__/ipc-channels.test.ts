...
const EXPECTED_CHANNELS: string[] = [
  ...
  'sessions:getTeamContextOverride',
  ...
  'sessions:setNotes',
  'sessions:setTeamContextOverride',
  ...
  'shell:showInFolder',
  'skills:changed',
  'skills:checkMarketUpdates',
  'skills:create',
  'skills:delete',
  'skills:deleteMarket',
  'skills:devopsAutoInstall',
  'skills:extractZip',
  'skills:fetchMarketContent',
  'skills:forceWrite',
  'skills:get',
  'skills:getFiles',
  'skills:installLocalZip',
  'skills:installMarket',
  'skills:installMarketplace',
  'skills:listMarket',
  'skills:openEditor',
  'skills:openFinder',
  'skills:publishDirectMarketplace',
  'skills:publishMarketplace',
  'skills:resolveRemote',
  'skills:triggerUpdateCheck',
  'skills:updateMarketBatch',
  'skills:updateMarketplace',
  'skills:uploadMarket',
  'sources:changed',
  'sources:create',
  'sources:delete',
  'sources:generateGuide',
  'sources:get',
  'sources:getMcpTools',
  'sources:getPermissions',
  'sources:importMcpJsonCandidates',
  'sources:parseMcpJsonImport',
  'sources:refreshMcpTools',
  ...
  'system:versions',
  'tasks:getOutput',
  'teamPublicKnowledge:changed',
  'teamPublicKnowledge:getConfig',
  'teamPublicKnowledge:getPreview',
  'teamPublicKnowledge:refresh',
  'teamPublicKnowledge:updateConfig',
  'theme:appChanged',
  ...
  'workspace:addChatFeedback',
  'workspace:deleteChatFeedback',
  'workspace:deleteChatFeedbackState',
  'workspace:filesChanged',
  'workspace:getChatFeedbackState',
  'workspace:getFiles',
  'workspace:getPermissions',
  'workspace:listChatFeedback',
  'workspace:readImage',
  'workspace:setChatFeedbackState',
  'workspace:unwatchFiles',
  'workspace:updateChatFeedback',
