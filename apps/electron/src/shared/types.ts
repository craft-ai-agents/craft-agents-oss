...
export interface ElectronAPI {
  ...
  getNetworkProxySettings(): Promise<import('@craft-agent/shared/config').NetworkProxySettings>
  setNetworkProxySettings(settings: import('@craft-agent/shared/config').NetworkProxySettings): Promise<void>
