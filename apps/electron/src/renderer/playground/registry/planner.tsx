...
import { TiptapMarkdownEditor } from '@archstudio/ui'
...
const events: PlannerTaskEvent[] = [
  ...
  { id: 'e4', taskId: 't1', type: 'task.session_snapshot_updated', at: 'Today · 18:42', actor: 'ARCHstudio', payloadSummary: 'Refreshed snapshot summary' },
]
