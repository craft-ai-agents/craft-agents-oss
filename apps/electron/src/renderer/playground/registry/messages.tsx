...
// Uses shared components from @archstudio/ui where available
// ============================================================================
...
`} />
      ...
      {/* Section: SystemMessage (from @archstudio/ui) */}
      <section>
...
export const messagesComponents: ComponentEntry[] = [
  ...
  },
  {
    ...
    category: 'Chat Messages',
    description: 'Right-aligned user message bubble (from @archstudio/ui)',
  ...
  },
  {
    ...
    name: 'SystemMessage',
    category: 'Chat Messages',
    description: 'System/info/warning/error message (from @archstudio/ui)',
