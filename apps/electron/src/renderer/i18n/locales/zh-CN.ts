...
export const zhCN = {
  ...
  settings: {
    ...
    workspace: {
      ...
      permissions: '权限',
      defaultMode: '默认模式',
      controlWhatAiCanDo: '控制 AI 可以做什么',
      readOnlyNoChangesAllowed: '只读，不允许更改',
      promptsBeforeMakingEdits: '在进行编辑前提示',
      fullAutonomousExecution: '完全自主执行',
      modeCycling: '模式循环',
      selectWhichModesToCycleThrough: '选择使用 Shift+Tab 循环的模式',
      atLeast2ModesRequired: '至少需要 2 个模式',
      defaultSources: '默认数据源',
      sourcesAutoEnabledForNewSessions: '新会话自动启用的数据源',
      noSourcesConfigured: '此工作区中未配置数据源。',
      advanced: '高级',
      defaultWorkingDirectory: '默认工作目录',
      notSetUsesSessionFolder: '未设置（使用会话文件夹）',
      clear: '清除',
      localMcpServers: '本地 MCP 服务器',
      enableStdioSubprocessServers: '启用标准输入输出子进程服务器'
    },
    permissions: {
      label: '权限',
      description: '探索模式规则',
