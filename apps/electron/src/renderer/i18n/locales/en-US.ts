...
export const enUS = {
  ...
  'session.action.selectMode': 'Select',
  'session.action.exitSelectMode': 'Exit select mode',
  'session.action.selectAll': 'Select all',
  'session.action.done': 'Done',
  ...
  'settings.workspace.section.defaultSources': 'Default Sources',
  'settings.workspace.section.defaultSources.description': 'Sources enabled automatically when creating new sessions',
  'settings.workspace.noSources': 'No sources configured',
