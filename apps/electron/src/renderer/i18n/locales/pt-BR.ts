...
export const ptBR: Record<TranslationKey, TranslationEntry> = {
  ...
  'sidebar.nav.scheduler': 'Agendamentos',
  ...
  'session.action.selectMode': 'Selecionar',
  'session.action.exitSelectMode': 'Sair do modo de seleção',
  'session.action.selectAll': 'Selecionar tudo',
  'session.action.done': 'Concluído',
  'session.selected': 'selecionados',
  'search': 'Buscar',
  ...
  'settings.workspace.section.defaultSources': 'Fontes Padrão',
  'settings.workspace.section.defaultSources.description': 'Fontes habilitadas automaticamente ao criar novas sessões',
  'settings.workspace.noSources': 'Nenhuma fonte configurada',
