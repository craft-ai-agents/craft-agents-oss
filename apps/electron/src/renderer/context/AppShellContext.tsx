...
export interface AppShellContextType {
  ...
  getDraftAttachmentRefs: (sessionId: string) => import('@archstudio/shared/config').DraftAttachmentRef[]
  ...
  onSendMessage: (sessionId: string, message: string, attachments?: FileAttachment[], skillSlugs?: string[], badges?: import('@archstudio/core').ContentBadge[]) => void
