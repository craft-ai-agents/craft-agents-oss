        ...
        <EmptyContent>
          {docKey && (
            <button
              ...
              className="inline-flex items-center h-7 px-3 text-sm font-medium rounded-[8px] bg-foreground/[0.02] shadow-minimal hover:bg-foreground/[0.05] transition-colors"
            >
              {t("common.learnMore")}
            </button>
          )}
