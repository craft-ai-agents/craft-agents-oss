...
import { usePlatform } from '@archstudio/ui'
...
const EDIT_CONFIGS: Record<EditContextKey, (location: string) => EditConfig> = {
  ...
  'default-permissions': (location) => ({
    context: {
      ...
      context:
        'The user is editing app-level default permissions (~/.archstudio/permissions/default.json). ' +
  ...
  'preferences-notes': (location) => ({
    context: {
      ...
      context:
        'The user is editing the notes field in their preferences (~/.archstudio/preferences.json). ' +
  ...
  'add-source': (location) => ({
    context: {
      ...
      context:
        ...
        'Follow the patterns in ~/.archstudio/docs/sources.md. ' +
  ...
  'add-skill': (location) => ({
    context: {
      ...
      context:
        ...
        'Follow the patterns in ~/.archstudio/docs/skills.md. ' +
  ...
  'edit-labels': (location) => ({
    context: {
      ...
      context:
        ...
        'Read ~/.archstudio/docs/labels.md for full format reference. ' +
        'Confirm clearly when done.',
    },
  ...
  'edit-tool-icons': (location) => ({
    context: {
      ...
      context:
        ...
        'The file is tool-icons.json in ~/.archstudio/tool-icons/. Icon image files live in the same directory. ' +
        ...
        'Read ~/.archstudio/docs/tool-icons.md for full format reference. ' +
  ...
  'automation-config': (location) => ({
    context: {
      ...
      context:
        ...
        'Read ~/.archstudio/docs/automations.md for full format reference. ' +
...
export function EditPopover({
  ...
  const handleLegacySendMessage = useCallback((message: string) => {
    ...
    const url = `archstudio://action/new-session?input=${encodedInput}&send=true&mode=${permissionMode}&badges=${encodedBadges}${workdirParam}${modelParam}${systemPromptParam}`
