...
const EDIT_CONFIGS: Record<EditContextKey, (location: string) => EditConfig> = {
  ...
  'default-permissions': (location) => ({
    context: {
      ...
      context:
        'The user is editing app-level default permissions (~/.vesper/permissions/default.json). ' +
  ...
  'preferences-notes': (location) => ({
    context: {
      ...
      context:
        'The user is editing the notes field in their preferences (~/.vesper/preferences.json). ' +
  ...
  'add-source-local': (location) => ({
    context: {
      ...
      context:
        ...
        'First, look up the guide: mcp__vesper-docs__SearchVesperAgents({ query: "filesystem" }). ' +
  ...
  'add-skill': (location) => ({
    context: {
      ...
      context:
        ...
        'Follow the patterns in ~/.vesper/docs/skills.md. ' +
