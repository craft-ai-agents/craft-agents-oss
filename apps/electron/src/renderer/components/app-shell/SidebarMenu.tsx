...
import { getDocUrl, type DocFeature } from '@archstudio/shared/docs/doc-links'
...
export function SidebarMenu({
  ...
  if (type === 'newSession') {
    return (
      <MenuItem onClick={() => window.electronAPI.openUrl('archstudio://action/new-session?window=focused')}>
