 ...
 * HookEventTimeline
 *
 * Compact timeline showing recent hook executions.
 * Displayed as a section within HookInfoPage.
 */
...
export function HookEventTimeline({ entries, className }: HookEventTimelineProps) {
  if (entries.length === 0) {
    return (
