 ...
 * HookCard
 *
 * Expandable inline row for compact hook display.
    ...
    >
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="text-sm font-medium truncate">{hook.name}</div>
          <div className="text-xs text-foreground/50 truncate">{hook.summary}</div>
        </div>
