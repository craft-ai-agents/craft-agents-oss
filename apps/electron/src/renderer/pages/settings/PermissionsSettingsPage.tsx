 ...
 * Shows both default patterns (from ~/.archstudio/permissions/default.json)
 * and custom workspace additions (from workspace permissions.json).
 *
 * Default patterns can be edited by the user in ~/.archstudio/permissions/default.json.
...
import { getDocUrl } from '@archstudio/shared/docs/doc-links'
...
/**
 * Build default permissions data from ~/.archstudio/permissions/default.json.
