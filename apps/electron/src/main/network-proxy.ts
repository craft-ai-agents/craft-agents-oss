...
import { getNetworkProxySettings, setNetworkProxySettings } from '@archstudio/shared/config/storage';
import type { NetworkProxySettings } from '@archstudio/shared/config/types';
