...
async function getExpectedCoreChannels(): Promise<Set<string>> {
  ...
  const [
    ...
    import('@craft-agent/server-core/handlers/rpc/outputs'),
    ...
    import('@craft-agent/server-core/handlers/rpc/notifications'),
    import('@craft-agent/server-core/handlers/rpc/pulses'),
  ...
  return new Set([
    ...
    ...notifications.HANDLED_CHANNELS,
    ...pulses.HANDLED_CHANNELS,
