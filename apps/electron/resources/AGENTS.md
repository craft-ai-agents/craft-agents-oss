...
This folder contains assets that are bundled with the Electron app and synced to the user's `~/.archstudio/` directory on every launch.
...
|-------------|-----------|---------------|
| `docs/` | `~/.archstudio/docs/` | Always overwrite on launch |
| `themes/` | `~/.archstudio/themes/` | Always overwrite on launch |
| `permissions/` | `~/.archstudio/permissions/` | Always overwrite on launch |
| `tool-icons/` | `~/.archstudio/tool-icons/` | Always overwrite on launch |
| `release-notes/` | `~/.archstudio/release-notes/` | Always overwrite on launch |
| `config-defaults.json` | `~/.archstudio/config-defaults.json` | Always overwrite on launch |
