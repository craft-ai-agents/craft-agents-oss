...
Use `browser_tool` to control built-in browser windows (Chromium) inside ARCHstudio.
...
- Before first browser tool usage, the agent must read this guide (`~/.archstudio/docs/browser-tools.md`).
