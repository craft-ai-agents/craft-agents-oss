...
Use `browser_tool` to control built-in browser windows (Chromium) inside MDP.
...
- Before first browser tool usage, the agent must read this guide (`~/.mdp-agent/docs/browser-tools.md`).
