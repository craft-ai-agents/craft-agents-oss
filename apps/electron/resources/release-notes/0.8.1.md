...
- **Artifact naming consistency** — Build scripts, CI workflows, install scripts, docs, and download links now consistently use the plural `MDP-*` artifact naming.
...
- **Docker defaults** — Fixed Dockerfile and Compose defaults around `.mdp-agent` directory ownership, ports, and volume behavior for self-hosted server setups.
