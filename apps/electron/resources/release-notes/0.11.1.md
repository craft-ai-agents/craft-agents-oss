# v0.11.1 — Fork Release: Label Skills, GitHub Updates & Pinned Chats

This fork release layers the label-driven workflow tooling and GitHub Releases update path on top of upstream v0.11.0, then adds pinned chats for easier session navigation.
