...
MDP now supports **Claude Opus 4.6** (`claude-opus-4-6`) — Anthropic's latest and most capable model.

### What Changed

- **New top-tier model** — Opus 4.6 is OUT and now available in MDP too!
