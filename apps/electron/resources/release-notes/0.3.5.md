...
Runner now supports **Claude Opus 4.6** (`claude-opus-4-6`) — Anthropic's latest and most capable model.

### What Changed

- **New top-tier model** — Opus 4.6 is OUT and now available in Runner too!
...
| Issue | Title | Status |
|-------|-------|--------|
| [#73](https://github.com/findmikeymike/RunnerOS) | Auto-update | Partially addressed |
| [#127](https://github.com/findmikeymike/RunnerOS) | Google OAuth tokens not injected | Partially addressed (docs) |
...
**Full Changelog**: [v0.3.4...v0.3.5](https://github.com/findmikeymike/RunnerOS)
