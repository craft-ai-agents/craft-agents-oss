...
- Added 30-second timeout to Copilot auth model fetching to prevent infinite hang (Fixes [#228](https://github.com/findmikeymike/RunnerOS)) (c8f46f59)
...
- Added `session-mcp-server` and `bridge-mcp-server` to OSS allow list (Fixes [#226](https://github.com/findmikeymike/RunnerOS)) (101ebf99)
