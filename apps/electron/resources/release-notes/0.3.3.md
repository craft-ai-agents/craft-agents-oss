...
When your OAuth token expires, Runner automatically refreshes it in the background using the refresh token. No manual re-authentication required — your MCP connections stay alive.
...
- Lazy loading of bundled docs fixes packaged app initialization ([RunnerOS#162](https://github.com/findmikeymike/RunnerOS))
...
| Issue | Title | Status |
|-------|-------|--------|
| [#80](https://github.com/findmikeymike/RunnerOS) | Error invoking remote method 'update:install' | Fixed |
| [#120](https://github.com/findmikeymike/RunnerOS) | Error when upgrading to newer version | Fixed |
| [#162](https://github.com/findmikeymike/RunnerOS) | Missing documentation folder after install | Fixed |
...
**Full Changelog**: [v0.3.2...v0.3.3](https://github.com/findmikeymike/RunnerOS)
