...
MDP now renders diagrams natively using [beautiful-mermaid](https://github.com/lukilabs/beautiful-mermaid) — our new open-source Mermaid rendering engine. No external dependencies, no browser DOM, just pure TypeScript.
...
**Theming**
Uses elegant two-color foundation — background and foreground colors derive all visual elements via CSS `color-mix()`. Diagrams automatically match your MDP theme.
