...
- **Messaging gateway delivers the final assistant message in `progress` / `final_only` modes** — The buffering paths could drop the terminal message when the gateway buffered partial deltas; the final-flush now consistently delivers it. (`13187c2c`)
