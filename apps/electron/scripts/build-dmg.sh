...
echo "=== Building ARCHstudio DMG (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder.yml uses artifactName to output: ARCHstudio-${arch}.dmg
DMG_NAME="ARCHstudio-${ARCH}.dmg"
