...
// =============================================================================
// WebAgentAPI — type-safe IPC API exposed to renderer
// =============================================================================

// Re-import types for WebAgentAPI
import type { WorkspaceInfo, Workspace, SessionMetadata, StoredAttachment as StoredAttachmentType } from '@craft-agent/core/types';

// Import protocol types used by WebAgentAPI (they come through the `export *` above,
...
export interface WebAgentAPI {
  ...
  respondToAsk(sessionId: string, requestId: string, choice: string | null): Promise<void>
  ...
  // System
  getVersions(): { node: string; chrome: string; runtime: string }
