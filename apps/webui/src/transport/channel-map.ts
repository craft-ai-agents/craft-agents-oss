/**
 * Channel map — maps WebAgentAPI method names to RPC channels.
 *
 * Single source of truth for the method→channel mapping used by buildClientApi().
 */
...
export const CHANNEL_MAP = {
  ...
  respondToAsk: invoke(RPC_CHANNELS.sessions.RESPOND_TO_ASK),
