#!/usr/bin/env bash
# install-server.sh — Set up the ARCHstudio standalone server.
#
# Usage:
...
echo ""
echo "===================================="
echo "  ARCHstudio Server Ready"
echo "===================================="
echo ""
echo "Start the server (with Web UI):"
echo ""
echo "  ARCHSTUDIO_SERVER_TOKEN=$TOKEN \\"
echo "  ARCHSTUDIO_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  ARCHSTUDIO_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
...
echo "  ARCHSTUDIO_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  ARCHSTUDIO_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
echo "  ARCHSTUDIO_RPC_HOST=0.0.0.0 \\"
echo "  ARCHSTUDIO_RPC_PORT=9100 \\"
echo "  bun run $REPO_ROOT/packages/server/src/index.ts"
echo ""
...
echo "  ARCHSTUDIO_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  ARCHSTUDIO_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
echo "  ARCHSTUDIO_RPC_TLS_CERT=/path/to/cert.pem \\"
echo "  ARCHSTUDIO_RPC_TLS_KEY=/path/to/key.pem \\"
echo "  bun run $REPO_ROOT/packages/server/src/index.ts"
echo ""
