...
#   ARCHSTUDIO_RPC_TLS_CERT=certs/cert.pem ARCHSTUDIO_RPC_TLS_KEY=certs/key.pem bun run server:dev
...
echo "  ARCHSTUDIO_RPC_TLS_CERT=$OUT_DIR/cert.pem ARCHSTUDIO_RPC_TLS_KEY=$OUT_DIR/key.pem bun run server:dev"
