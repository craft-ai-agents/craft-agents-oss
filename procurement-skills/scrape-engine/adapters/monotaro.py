#!/usr/bin/env python3
"""GENERIC SSR-dump adapter 'monotaro' — mode=dom, body-text -> Row.note.
Ported from procurement-platform-search-more/scripts/cloak_search.py
(scrape_generic + GENERIC table row 'monotaro'). url_tpl + needs_proxy lifted as-is;
