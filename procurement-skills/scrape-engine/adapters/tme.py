#!/usr/bin/env python3
"""GENERIC SSR-dump adapter 'tme' — mode=dom, body-text -> Row.note.
Ported from legacy extended-source cloak_search.py
(scrape_generic + GENERIC table row 'tme'). url_tpl + needs_proxy lifted as-is;
...
ADAPTER = make_generic(
    'tme',
    'https://www.tme.eu/en/katalog/?queryPhrase={q}',
    True,
)
