#!/usr/bin/env python3
"""GENERIC SSR-dump adapter 'future' — mode=dom, body-text -> Row.note.
Ported from legacy extended-source cloak_search.py
(scrape_generic + GENERIC table row 'future'). url_tpl + needs_proxy lifted as-is;
...
ADAPTER = make_generic(
    'future',
    'https://www.futureelectronics.com/search?q={q}',
    False,
)
