#!/usr/bin/env python3
"""GENERIC SSR-dump adapter 'szlcsc' — mode=dom, body-text -> Row.note.
Ported from procurement-platform-search-more/scripts/cloak_search.py
(scrape_generic + GENERIC table row 'szlcsc'). url_tpl + needs_proxy lifted as-is;
...
ADAPTER = make_generic(
    'szlcsc',
    'https://so.szlcsc.com/global.html?k={q}',
    False,
)
