#!/usr/bin/env python3
"""GENERIC SSR-dump adapter 'peigenesis' — mode=dom, body-text -> Row.note.
Ported from legacy extended-source cloak_search.py
(scrape_generic + GENERIC table row 'peigenesis'). url_tpl + needs_proxy lifted as-is;
...
ADAPTER = make_generic(
    'peigenesis',
    'https://www.peigenesis.com/product/search?search={q}',
    True,
)
