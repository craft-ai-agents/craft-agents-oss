# Contributing to G4 OS

Thank you for your interest in contributing to G4 OS! This document provides guidelines and instructions for contributing.
...
└── packages/
    ├── core/        # @g4os/core - Shared types
    ├── shared/      # @g4os/shared - Business logic
    └── ui/          # @g4os/ui - React components
```
