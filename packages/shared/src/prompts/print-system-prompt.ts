#!/usr/bin/env bun
/**
 * Debug script to print the full Runner system prompt with annotations.
...
${colors.bgMagenta}${colors.bold}                    RUNNER SYSTEM PROMPT BREAKDOWN                         ${colors.reset}
${colors.bgMagenta}${colors.bold}                                                                                ${colors.reset}
`);
...
printAnnotation('  2. Runner Environment Marker - version, platform, arch');
...
${colors.bold}SDK Configuration:${colors.reset}
  ...
  systemPrompt.append: getSystemPrompt() ${colors.dim}// Runner additions (static, cacheable)${colors.reset}
...
${colors.bold}Static System Prompt Components:${colors.reset}
  ...
  2. Runner Environment Marker      ${colors.dim}// Version, platform, arch${colors.reset}
