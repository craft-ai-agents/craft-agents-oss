 ...
 * Генерация: `bun scripts/toolchain-locks.ts pip <name>@<version> <pypi-spec>`
 * (uv pip compile --generate-hashes) или `uv pip compile --generate-hashes - <<< 'pkg==ver'`.
 */
...
const PIP_LOCKS: Record<string, string> = {
  ...
  // cli-anything 0.4.1 — CLI-Anything hub (cli-anything-hub + deps). Console: cli-hub → cli_hub.cli.
  // Lock body from `uv pip compile --generate-hashes` (PyPI 2026-08-08); keep comments.
  'cli-anything@0.4.1': `# This file was autogenerated by uv via the following command:
#    uv pip compile --generate-hashes -o /tmp/cli-anything.req.txt -
certifi==2026.7.22 \\
...
cli-anything-hub==0.4.1 \\
    --hash=sha256:95c46b6121c4b784fdf71f5524003b0fa063291397d6b2614995215138b2534b \\
    --hash=sha256:a8d5ab1300c8474febf60f8bb38a51a0aec3828292c67b38b336df1cb3c1697f
click==8.4.2 \\
    --hash=sha256:9a6cea6e60b17ebe0a44c5cc636d94f09bd66142c1cd7d8b4cd731c4917a15f6 \\
    --hash=sha256:e6f9f66136c816745b9d65817da91d61d957fb16e02e4dcd0552553c5a197b76
    # via cli-anything-hub
idna==3.18 \\
