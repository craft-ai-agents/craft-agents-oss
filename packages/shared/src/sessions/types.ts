...
import type { StoredAttachment, MessageRole, ToolStatus, AuthRequestType, AuthStatus, CredentialInputMode, StoredMessage } from '@g4os/core/types';
 ...
 * Re-exported from @g4os/core for convenience
 */
export type { StoredMessage } from '@g4os/core/types';
...
export interface SessionHeader {
  ...
  /** SDK session ID (captured after first message) */
  sdkSessionId?: string;
  /** Workspace root path (stored as portable path, e.g., ~/.g4os/...) */
  workspaceRootPath: string;
  /** Optional user-defined name */
  name?: string;
  createdAt: number;
