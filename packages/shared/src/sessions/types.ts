...
import type { StoredAttachment, MessageRole, ToolStatus, AuthRequestType, AuthStatus, CredentialInputMode, StoredMessage } from '@vesper/core/types';
 ...
 * Re-exported from @vesper/core for convenience
 */
export type { StoredMessage } from '@vesper/core/types';
...
export interface SessionHeader {
  ...
  /** SDK session ID (captured after first message) */
  sdkSessionId?: string;
  /** Workspace root path (stored as portable path, e.g., ~/.vesper/...) */
  workspaceRootPath: string;
  /** Optional user-defined name */
  name?: string;
  createdAt: number;
