...
export const RPC_CHANNELS = {
  ...
  workspace: {
    ...
    GET_CHAT_FEEDBACK_STATE: 'workspace:getChatFeedbackState',
    SET_CHAT_FEEDBACK_STATE: 'workspace:setChatFeedbackState',
    DELETE_CHAT_FEEDBACK_STATE: 'workspace:deleteChatFeedbackState',
    LIST_CHAT_FEEDBACK: 'workspace:listChatFeedback',
    ADD_CHAT_FEEDBACK: 'workspace:addChatFeedback',
    UPDATE_CHAT_FEEDBACK: 'workspace:updateChatFeedback',
    DELETE_CHAT_FEEDBACK: 'workspace:deleteChatFeedback',
