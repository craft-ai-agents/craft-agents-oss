 ...
 *
 * Watched paths:
 * - ~/.mdp-agent/config.json - Main app configuration
 * - ~/.mdp-agent/preferences.json - User preferences
 * - ~/.mdp-agent/theme.json - App-level theme overrides
 * - ~/.mdp-agent/themes/*.json - Preset theme files (app-level)
 * - ~/.mdp-agent/workspaces/{slug}/ - Workspace directory (recursive)
...
export interface ConfigWatcherCallbacks {
  ...
  /** Called when app-level default permissions change (~/.mdp-agent/permissions/default.json) */
...
export class ConfigWatcher {
  ...
  /**
   * Watch app-level themes directory (~/.mdp-agent/themes/)
   */
  ...
  /**
   * Watch app-level permissions directory (~/.mdp-agent/permissions/)
