 ...
 *
 * Watched paths:
 * - ~/.archstudio/config.json - Main app configuration
 * - ~/.archstudio/preferences.json - User preferences
 * - ~/.archstudio/theme.json - App-level theme overrides
 * - ~/.archstudio/themes/*.json - Preset theme files (app-level)
 * - ~/.archstudio/workspaces/{slug}/ - Workspace directory (recursive)
...
export interface ConfigWatcherCallbacks {
  ...
  /** Called when app-level default permissions change (~/.archstudio/permissions/default.json) */
...
export class ConfigWatcher {
  ...
  /**
   * Watch app-level themes directory (~/.archstudio/themes/)
   */
  ...
  /**
   * Watch app-level permissions directory (~/.archstudio/permissions/)
