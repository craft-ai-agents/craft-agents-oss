 ...
 * Guides are now served exclusively via the docs MCP server.
 *
 ...
 * Use the docs MCP server to search for setup guides.
 *
 * Example: search the docs MCP tool list for "github source setup guide".
 */
