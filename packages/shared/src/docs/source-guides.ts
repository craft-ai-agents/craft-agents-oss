 ...
 * Guides are now served exclusively via the g4os-docs MCP server.
 *
 ...
 * Use the g4os-docs MCP server to search for setup guides.
 *
 * Example: mcp__g4os-docs__SearchG4OS({ query: "github source setup guide" })
 */
