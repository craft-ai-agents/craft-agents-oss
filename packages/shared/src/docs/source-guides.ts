 ...
 * Guides are now served exclusively via the vesper-docs MCP server.
 *
 ...
 * Use the vesper-docs MCP server to search for setup guides.
 *
 * Example: mcp__vesper-docs__SearchVesperAgents({ query: "github source setup guide" })
 */
