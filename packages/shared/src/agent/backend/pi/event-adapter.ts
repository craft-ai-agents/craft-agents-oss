 ...
 * ARCHstudio's AgentEvent format for UI compatibility.
 *
...
import type { AgentEvent as CraftAgentEvent } from '@archstudio/core/types';
import type {
...
/**
 * Maps Pi SDK events to ARCHstudioEvents for UI compatibility.
 *
 * Event mapping:
...
export class PiEventAdapter extends BaseEventAdapter {
  ...
  /**
   * Adapt a Pi SDK event to zero or more ARCHstudioEvents.
   */
