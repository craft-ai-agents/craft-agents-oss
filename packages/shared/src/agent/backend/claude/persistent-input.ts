 ...
 *
 * `ARCHSTUDIO_KEEP_BG_AGENTS_ALIVE`:
 ...
 * `ARCHSTUDIO_KEEP_BG_AGENTS_ALIVE=0` to fall back to the per-turn kill-switch.
 */
...
export function resolveKeepBackgroundTasksAlive(
  ...
  const raw = env.ARCHSTUDIO_KEEP_BG_AGENTS_ALIVE;
