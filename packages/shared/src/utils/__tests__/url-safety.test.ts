...
describe('classifyExternalUrl — internal deep links', () => {
  it('classifies mdp:// as internal-deeplink', () => {
    expect(classifyExternalUrl('mdp://settings').kind).toBe('internal-deeplink')
  })
...
describe('isSafeExternalUrl', () => {
  ...
  it('returns false for internal deep links', () => {
    expect(isSafeExternalUrl('mdp://settings')).toBe(false)
  })
