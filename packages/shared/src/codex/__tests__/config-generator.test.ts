...
describe('generateCodexConfig', () => {
  ...
  describe('header comment', () => {
    it('should include generation comment', () => {
      ...
      expect(result.toml).toContain('# Generated by G4 OS - DO NOT EDIT');
...
describe('getCredentialCachePath', () => {
  it('should return correct path', () => {
    const path = getCredentialCachePath('/home/user/.g4os/workspaces/ws-123', 'gmail');
    expect(path).toBe('/home/user/.g4os/workspaces/ws-123/sources/gmail/.credential-cache.json');
  });
});
