...
Shared TypeScript types and utilities for ARCHstudio applications.

## Installation

```bash
# In a workspace package
bun add @archstudio/core
```
...
import type {
  ...
  TokenUsage,
  AgentEvent,
} from '@archstudio/core';

// Import utilities
import { generateMessageId, debug } from '@archstudio/core';
```
