...
This file provides guidance to Claude Code when working with the `@g4os/core` package.
...
The core package provides shared TypeScript types and utilities used by the Electron app and shared packages. It serves as the type definition layer for the G4 OS monorepo.
...
| `AgentEvent` | Events from G4Agent during chat (incl. task_backgrounded, shell_backgrounded, task_progress) |
...
// Import utilities
import { generateMessageId, debug } from '@g4os/core';

// Or import from specific subpaths
import type { Session } from '@g4os/core/types';
```
...
2. **Phase 2:** Move storage logic to `@g4os/core`
