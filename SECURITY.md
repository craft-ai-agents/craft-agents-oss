...
We take security seriously. If you discover a security vulnerability in Runner, please report it responsibly.

### How to Report

**Please do NOT report security vulnerabilities through public GitHub issues.**

Instead, please send an email to: **security@runneros.local**
...
- The Runner desktop application
- The `@craft-agent/*` npm packages
- Official Runner repositories
