...
This trademark policy governs the use of the "Craft" and "G4 OS" names, logos, and branding in connection with the G4 OS open source project.

## Trademarks

The following are trademarks of G4 Educacao:

- **Craft** (word mark)
- **G4 OS** (word mark)
- The Craft logo and icon
- The G4 OS logo and icon

## What You Can Do

### Use the Code Freely

The G4 OS source code is licensed under the Apache License 2.0. You are free to:
...
- "Based on G4 OS"
- "Built with G4 OS technology"
- "Compatible with G4 OS"
- "Fork of G4 OS"

### Contribute to the Project

Contributors to the official G4 OS repository may use the trademarks when discussing their contributions.
...
- Update the bundle identifier (e.g., `com.lukilabs.g4os`) to your own
...
- Use "Craft" or "G4 OS" as your product name
- Use the Craft logo as your application icon
- Suggest that your fork is the official version
- Imply that G4 Educacao or Craft endorses your product

### Create Confusion

You may not use the trademarks in any way that:

- Suggests your product is created by or affiliated with G4 Educacao
- Could cause confusion between your product and the official G4 OS
- Disparages G4 Educacao or the G4 OS project
...
- "MyAgent - based on G4 OS"
- "This project is a fork of G4 OS"
- "Compatible with the G4 OS ecosystem"
