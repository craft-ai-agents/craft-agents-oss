...
This trademark policy governs the use of the "Craft" and "ARCHstudio" names, logos, and branding in connection with the ARCHstudio open source project.
...
- **Craft** (word mark)
- **ARCHstudio** (word mark)
- The Craft logo and icon
- The ARCHstudio logo and icon

## What You Can Do

### Use the Code Freely

The ARCHstudio source code is licensed under the Apache License 2.0. You are free to:
...
Contributors to the official ARCHstudio repository may use the trademarks when discussing their contributions.
...
- Update the bundle identifier (e.g., `com.lukilabs.archstudio`) to your own
...
- Use "Craft" or "ARCHstudio" as your product name
...
- Could cause confusion between your product and the official ARCHstudio
- Disparages Craft Docs Ltd. or the ARCHstudio project
